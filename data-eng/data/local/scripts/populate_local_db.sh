...
echo "=== 1. Creating tables from BigQuery schemas (raw_dev, staging_dev, mart_dev) ==="
python data/local/scripts/bq_schema_to_local_pg.py

echo ""
echo "=== 2. Syncing data into local tables (to schemas raw_dev/staging_dev/mart_dev) ==="
...
echo ""
echo "Done. Check your local DB (e.g. datateam_local) for schemas raw_dev, staging_dev, mart_dev and world_country_usa_states_latlong."
