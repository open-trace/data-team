...
Warehouse ingestion, dbt, Airflow, and Terraform live under **`data-eng/`** at the repo root (see [data-eng/README.md](../data-eng/README.md)). Shared local files such as **`data/local/.env`** still apply to both areas.
